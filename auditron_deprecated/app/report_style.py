...
from AuditronAI.app.visualizations import show_code_metrics, create_code_stats_chart
...
def show_analysis_report(result: dict):
    ...
    st.markdown("""
        <div style='background: #1E1E1E; padding: 20px; border-radius: 10px; 
                  ...
                  margin-bottom: 20px;'>
            <h2 style='color: white; margin: 0;'>Analyse du code</h2>
            <div style='background: #4CAF50; width: 50px; height: 50px; border-radius: 50%; 
    ...
    with col1:
        st.markdown("""
            <div style='background: #2E2E2E; padding: 15px; border-radius: 10px; text-align: center;
                      border-left: 4px solid #FF4444;'>
                <div style='font-size: 20px;'>🐛</div>
                <div style='font-size: 24px; color: white;'>0</div>
                <div style='color: #888;'>Bugs</div>
            </div>
        """, unsafe_allow_html=True)
    with col2:
        st.markdown("""
            <div style='background: #2E2E2E; padding: 15px; border-radius: 10px; text-align: center;
                ...
                <div style='font-size: 20px;'>🔒</div>
                <div style='font-size: 24px; color: white;'>0</div>
                <div style='color: #888;'>Vulnérabilités</div>
            </div>
        """, unsafe_allow_html=True)
    with col3:
        st.markdown("""
            <div style='background: #2E2E2E; padding: 15px; border-radius: 10px; text-align: center;
                ...
                <div style='font-size: 20px;'>🔍</div>
                <div style='font-size: 24px; color: white;'>0</div>
                <div style='color: #888;'>Code Smells</div>
            </div>
        """, unsafe_allow_html=True)
